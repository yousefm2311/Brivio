...
class ReportsDashboardViewModel extends ChangeNotifier {
  ...
  final List<Map<String, dynamic>> parentsData = [
    {'name': 'Mr. & Mrs. Smith', 'students': 'Alice, Charlie', 'email': 'smith@example.com', 'status': 'Active'},
    {'name': 'Mr. Doe', 'students': 'Bob', 'email': 'doe@example.com', 'status': 'Inactive'},
  ];

  final List<Map<String, dynamic>> homeworkData = [
    {'group': 'Math 101', 'total': 15, 'completion_rate': '92%', 'avg_score': 88},
    {'group': 'Science 202', 'total': 10, 'completion_rate': '85%', 'avg_score': 76},
  ];

  final List<Map<String, dynamic>> curriculumData = [
    {'subject': 'Mathematics', 'total_modules': 12, 'completed_modules': 8, 'progress': '66%'},
    {'subject': 'Physics', 'total_modules': 10, 'completed_modules': 5, 'progress': '50%'},
  ];
