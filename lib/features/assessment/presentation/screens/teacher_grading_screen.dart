      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              approve
                  ? context.tr('Exam reset approved.')
                  : context.tr('Reset request rejected.'),
            ),
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverToBoxAdapter(
                      child: Text(
                        ...
                        style: AppTypography.titleMedium(textColor).copyWith(
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverList(
                      delegate: SliverChildBuilderDelegate((ctx, i) {
                        ...
                        final studentName =
                            req['students']?['profiles']?['full_name'] ??
                            'Student';
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            title: Text(
                              '$studentName requested a reset for $examTitle',
                              style: TextStyle(
                                color: textColor,
                                fontWeight: FontWeight.bold,
                              ),
                              ...
                              children: [
                                ...
                                isGraded
                                    ...
                                    : ElevatedButton(
                                        ...
                                        onPressed: () =>
                                            _showGradeSubmissionDialog(sub),
