      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(teacherClass.time, style: AppTypography.bodyMedium(textSecondary)),
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text(teacherClass.room, style: AppTypography.bodyMedium(textSecondary)),
                    ],
                  ),
                ],
              ),
            ...
            Text(
              'Student Roster (${teacherClass.students.length})',
              style: AppTypography.titleLarge(textPrimary),
            ),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(student.name, style: AppTypography.titleMedium(textPrimary)),
                              const SizedBox(height: 4),
                              Text('Attendance: ${student.attendanceRate}%', style: AppTypography.bodySmall(textSecondary)),
                            ],
                          ),
                        ),
                        Container(
