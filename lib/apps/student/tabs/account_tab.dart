...
import '../screens/student_helpdesk_screen.dart';
          ...
          sliver: SliverList(
            delegate: SliverChildListDelegate([
              ...
              FadeInSlide(
                ...
                child: _NotificationsGroup(
                  notifications: notifications,
                  onMarkRead: onNotificationTap,
                ),
              ),
              const SizedBox(height: 32),
              ...
              FadeInSlide(
                ...
                child: _AccountSectionHeader(text: context.tr('Support')),
              ),
              const SizedBox(height: 12),
              FadeInSlide(
                duration: const Duration(milliseconds: 600),
                ...
                child: _AppleGroupedList(
                  children: [
                    _AccountActionRow(
                      ...
                      title: context.tr('Help Desk'),
                      subtitle: context.tr(
                        'Send a support request and follow replies.',
                      ),
                      onTap: () => Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => const StudentHelpdeskScreen(),
                        ),
                      ),
                    ),
                  ],
...
class _NotificationsGroup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (notifications.isEmpty) {
      return _InlinePlaceholder(text: context.tr('No notifications yet.'));
    }
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        height: 40,
                        decoration: BoxDecoration(
                          color: (n.isRead ? AppColors.info : AppColors.warning)
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              '${n.message}  ·  ${_formatDate(n.createdAt)}',
                              style: AppTypography.caption(
                                textSecondary,
                              ).copyWith(fontWeight: FontWeight.w500),
                              maxLines: 1,
...
class _AnnouncementsGroup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (announcements.isEmpty) {
      return _InlinePlaceholder(text: context.tr('No announcements yet.'));
    }
      ...
      children: [
        if (summary != null) ...[
          PortalMetricGrid(
            children: [
              PortalMetricCard(
                label: context.tr('Total Invoiced'),
                value: _formatMoney(summary!.totalDueMinor, summary!.currency),
                icon: Icons.payments_rounded,
                accentColor: AppColors.warning,
              ),
              PortalMetricCard(
                label: context.tr('Paid'),
                value: _formatMoney(summary!.totalPaidMinor, summary!.currency),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 4),
                              Text(
                                '${_formatMoney(inv.totalMinor, inv.currency)}  ·  Due ${_formatDate(inv.dueAt)}',
                                style: AppTypography.caption(
                                  textSecondary,
                                ).copyWith(fontWeight: FontWeight.w500),
                              ),
          ...
          Expanded(
            child: Row(
              children: [
                Text(
                  text.toUpperCase(),
                  style: AppTypography.caption(textSecondary).copyWith(
